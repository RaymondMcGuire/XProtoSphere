 ...
 * @Date: 2023-02-20 01:43:03
 * @LastEditors: Xu.WANG raymondmgwx@gmail.com
 * @LastEditTime: 2023-02-20 01:44:12
 * @FilePath:
...
static __global__ void _WorldBoundaryConstrain_CUDA(float3 *pos, float3 *vel,
                                                    const size_t num,
...
static __global__ void _SetUpRndGen_CUDA(curandState *state,
                                         unsigned long seed) {
  int id = threadIdx.x;
