...
call .\build\bin\Release\xprotosphere.exe %input_model_name% %input_model_scale% %distribution_type% %protosphere_max_iter% %enable_dem_relax% %overlap_ratio% %dsr_max_iter%
